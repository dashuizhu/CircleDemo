...
public class ExpandTextView extends LinearLayout {
    ...
    public void setText(final CharSequence content){
        ...
        //if (mCircleMovementMethod == null) {
        //    mCircleMovementMethod = new CircleMovementMethod(getResources().getColor(R.color.name_selector_color));
        //    contentText.setMovementMethod(mCircleMovementMethod);
        //}
        //mCircleMovementMethod.setIsExpand(isExpand);
        contentText.setOnTouchListener(new OnTouchListener() {
            @Override public boolean onTouch(View v, MotionEvent event) {
                Log.w("test", ""+event.getAction());
                return false;
            }
        });
    }
